namespace krepsinisAPI.DTOs
{
    ...
    public record MatchDTO(int id, int homeTeamScore, int awayTeamScore, int? tournamentId, DateTime matchDate, int? homeTeamId, int? awayTeamId, string homeTeamName, string awayTeamName, string arena);
}
